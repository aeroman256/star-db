...
export default class SwapiService {
    ...
    _imagePath = 'https://starwars-visualguide.com/assets/img/'
    ...
    getPersonImage = ({id}) => {
        const res = `${this._imagePath}characters/${id}.jpg`
        return (
            res
        )
    }
    ...
    getStarshipImage = ({id}) => {
        return (
            `${this._imagePath}starships/${id}.jpg`
        )
    }

    getPlanetImage = ({id}) => {
        return (
            `${this._imagePath}planets/${id}.jpg`
        )
    }
